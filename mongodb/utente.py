...
apikey = "&appid=790103a2a81e03e9dd13ec518a5a1690"  # TODO prenderla da .env
...
if __name__ == '__main__':
    ...
    italian_city = input("vuoi cercare in italia? (y/n)\n")
    if italian_city.lower()[0] == "y":
        citta += ",it"

    response = urllib.request.urlopen(url + citta + apikey)  # TODO passare i params={}, non come str!
    data_json = json.loads(response.read())
    lat, lon = data_json[0]["lat"], data_json[0]["lon"]
